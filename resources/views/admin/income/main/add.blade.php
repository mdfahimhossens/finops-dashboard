...
@section('page')
                    <div class="row">
                        <div class="col-md-12 ">
                            <form method="post" action="{{url('dashboard/income/store')}}">
                              @csrf    
                            <div class="card mb-3">
                                  ...
                                  <div class="card-body">
                                      <div class="row mb-3">
                                        ...
                                        <div class="col-sm-7">
                                          <input type="text" class="form-control form_control" name="inc_name" value="{{old('inc_name')}}">
                                         @if($errors->has('inc_name'))
                                        <span class="invalid-feedback d-block" role="alert">
                                          <strong>{{ $errors->first('inc_name') }}</strong>
                                        </span>
                                          @endif
                                        </div>
                                      </div>
                                      ...
                                      <div class="row mb-3">
                                        ...
                                        <div class="col-sm-7">
                                          <input type="text" class="form-control form_control" name="inc_office">
                                          @if($errors->has('inc_office'))
                                        <span class="invalid-feedback d-block" role="alert">
                                          <strong>{{ $errors->first('inc_office') }}</strong>
                                        </span>
                                        @endif
                                        </div>
                                      </div>
                                      <div class="row mb-3">
                                        ...
                                        <div class="col-sm-7">
                                          <input type="text" class="form-control form_control" id="" name="inc_age" value="{{old('inc_age')}}">
                                      ...
                                      <div class="row mb-3">
                                        ...
                                        <div class="col-sm-7">
                                          <input type="text" class="form-control form_control" id="" name="inc_salary" value="{{old('inc_salary')}}">
                                      ...
                                      <div class="row mb-3">
                                        ...
                                        <div class="col-sm-7">
                                          <input type="date" class="form-control form_control" id="" name="inc_date" value="{{old('inc_date')}}">
