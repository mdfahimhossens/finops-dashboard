                            ...
                            <form method="post" action="{{url('dashboard/expense/category/update')}}">
                              ...
                              <div class="card mb-3">
                                  <div class="card-header">
                                    <div class="row">
                                        <div class="col-md-8 col-8 card_title_part">
                                            <i class="fab fa-gg-circle"></i>Update Category Information
                                        </div>  
                                ...
                                <div class="row mb-3 {{ $errors->has('name') ? ' has-error' : '' }}">
                                  ...
                                  <div class="col-sm-7">
                                    <input type="hidden" id="" name="id" value="{{$data->expencate_id}}">
                                    <input type="hidden" id="" name="slug" value="{{$data->expencate_slug}}">
                                    <input type="text" class="form-control form_control" id="" name="name" value="{{$data->expencate_name}}">
                                    @if($errors->has('name'))
                                ...
                                <div class="row mb-3">
                                  ...
                                  <div class="col-sm-7">
                                    <textarea class="form-control form_control" id="" name="remarks">{{$data->expencate_remarks}}</textarea>
                                  </div>
                                </div>
                                  </div>
